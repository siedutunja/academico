<template>
  <div>
    <b-row v-if="estadoDocumento==null">
      <b-col lg="12">
        <b-card>
          <template #header>
            <h5 class="mb-0"><b-icon icon="search" aria-hidden="true"></b-icon> CONSULTAR ESTUDIANTE</h5>
          </template>
          <b-card-text>
            <b-row>
              <b-col>
                  ...
                  <b-tab title="Busqueda por Documento" active>
                    <b-card style="margin-top: -17">
                        ...
                        <b-row>
                          <b-col lg="3" md="6">
                            <b-form-group label="Número de Documento*" label-for="doc" class="etiqueta">
                              <b-form-input id="doc" ref="doc" v-model.trim="docEstudiante" aria-describedby="feedDoc" autocomplete="off" maxlength="50"></b-form-input>
                      ...
                      <template #footer>
                        ...
                        <div>
                          <b-button class="small" variant="primary" @click="validarDocumentoEstudiante()">Buscar Estudiante</b-button>
            ...
            <b-row>
              <b-col lg="12">
                <b-alert show variant="info" class="p-5" v-if="estadoDocumento==1">
                  <h5 class="mb-5"><b>¡Excelente!</b></h5>
                  <h5 class="mb-3">El número de documento <span class="text-info"><b>({{ docEstudiante }})</b></span> se encuentra registrado en el sistema sieduTunja.</h5>
                ...
                <b-alert show variant="danger" class="p-5" v-else-if="estadoDocumento==3">
                  ...
                  <h5 class="mb-3">El número de documento <span class="text-info"><b>({{ docEstudiante }})</b></span> NO se encuentra registrado en el sistema.</h5>
                  <h5 class="mb-3">Para matricularlo en esta Institución se debe realizar el proceso de Preincipción.</h5>
                </b-alert>
              </b-col>
            </b-row>
          </b-card-text>
  ...
  export default {
    ...
    methods: {
      ...
      async guardarMatricula() {
        ...
        .then(response => {
          if (response.data.error){
            ...
            this.$router.push('/matriculas/FichaRenovacionMatricula2')
          }
        })
        .catch(err => {
        ...
        .then(response => {
          if (response.data.error){
            ...
            if (response.data.bandera == 0) {
              ...
              this.$store.commit('set', ['datosPreinscrito', response.data.datos])
              //console.log(JSON.stringify(this.$store.state.datosPreinscrito))
      ...
      llenarFormulario() {
        ...
        this.infoEstudiante.idEstudiante = this.$store.state.datosPreinscrito.id
        ...
        this.infoEstudiante.id_municipio_documento = this.$store.state.datosPreinscrito.id_municipio_documento
        ...
        this.infoEstudiante.id_municipio_nacimiento = this.$store.state.datosPreinscrito.id_municipio_nacimiento
        this.infoEstudiante.id_genero = this.$store.state.datosPreinscrito.id_genero
        this.infoEstudiante.id_rh = this.$store.state.datosPreinscrito.id_rh
        this.infoEstudiante.id_estrato = this.$store.state.datosPreinscrito.id_estrato
        ...
        this.infoEstudiante.id_capacidades = this.$store.state.datosPreinscrito.id_capacidades
        this.infoEstudiante.id_etnia = this.$store.state.datosPreinscrito.id_etnia
        this.infoEstudiante.id_victima = this.$store.state.datosPreinscrito.id_victima
        this.infoEstudiante.enfermedades = this.$store.state.datosPreinscrito.enfermedades
        this.infoEstudiante.id_diversa = 'N'
        this.infoEstudiante.id_eps = this.$store.state.datosPreinscrito.id_eps
        ...
        this.infoEstudiante.id_zona = this.$store.state.datosPreinscrito.id_zona
        ...
        this.infoEstudiante.codigo = this.$store.state.datosPreinscrito.codigo
        this.infoEstudiante.id_especialidad = '05'
        this.infoEstudiante.id_metodologia = 1
        this.infoEstudiante.id_nuevo = 'N'
        ...
        this.infoEstudiante.nombre1A = null
        this.infoEstudiante.nombre2A = null
        this.infoEstudiante.apellido1A = null
        this.infoEstudiante.apellido2A = null
