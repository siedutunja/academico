    ...
    methods: {
      ...
      validarDatosFormulario() {
        ...
        if (this.$v.infoEstudiante.$anyError) {
          ...
          let titulo = 'Renovar Matricula del Estudiante'
          let pregunta = '¿Esta seguro de renovar la matricula del estudiante?'
      ...
      llenarFormulario() {
        ...
        this.infoEstudiante.apellido1 = this.$store.state.datosEstudianteRenovar.apellido1
        this.infoEstudiante.apellido2 = this.$store.state.datosEstudianteRenovar.apellido2
        if (this.$store.state.datosEstudianteRenovar.fecha_nacimiento != null && this.$store.state.datosEstudianteRenovar.fecha_nacimiento != '') {
          this.infoEstudiante.fecha_nacimiento = this.$store.state.datosEstudianteRenovar.fecha_nacimiento.substr(0,10)
        } else {
          this.infoEstudiante.fecha_nacimiento = null
        }
        this.infoEstudiante.id_nacionalidad = this.$store.state.datosEstudianteRenovar.id_nacionalidad
        this.infoEstudiante.id_municipio_nacimiento = this.$store.state.datosEstudianteRenovar.id_municipio_nacimiento
        this.infoEstudiante.id_genero = this.$store.state.datosEstudianteRenovar.id_genero
        this.infoEstudiante.id_rh = this.$store.state.datosEstudianteRenovar.id_rh
        this.infoEstudiante.id_estrato = this.$store.state.datosEstudianteRenovar.id_estrato
        this.infoEstudiante.id_sisben = this.$store.state.datosEstudianteRenovar.id_sisben
        this.infoEstudiante.id_discapacidad = this.$store.state.datosEstudianteRenovar.id_discapacidad
        this.infoEstudiante.id_capacidades = this.$store.state.datosEstudianteRenovar.id_capacidades
        this.infoEstudiante.id_etnia = this.$store.state.datosEstudianteRenovar.id_etnia
        ...
        this.infoEstudiante.telefono1 = this.$store.state.datosEstudianteRenovar.telefono1
        this.infoEstudiante.telefono2 = this.$store.state.datosEstudianteRenovar.telefono2
        this.infoEstudiante.correo = this.$store.state.datosEstudianteRenovar.correo
        this.infoEstudiante.codigo = this.$store.state.datosEstudianteRenovar.codigo
        ...
        this.infoEstudiante.id_sisbenA = 0
        this.infoEstudiante.id_epsA = '000000'
        this.infoEstudiante.direccionA = this.$store.state.datosEstudianteRenovar.direccion
        this.infoEstudiante.id_municipio_direccionA = this.$store.state.datosEstudianteRenovar.id_municipio_direccion
        this.infoEstudiante.id_zonaA = 1
        this.infoEstudiante.telefono1A = this.$store.state.datosEstudianteRenovar.telefono1
        this.infoEstudiante.telefono2A = this.$store.state.datosEstudianteRenovar.telefono2
