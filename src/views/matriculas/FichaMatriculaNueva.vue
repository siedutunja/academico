  ...
  export default {
    ...
    methods: {
      ...
      async guardarMatricula() {
        ...
        await axios
        .post(CONFIG.ROOT_PATH + 'academico/matriculas/nuevapfc', JSON.stringify(this.infoEstudiante), { headers: {"Content-Type": "application/json; charset=utf-8" }})
        .then(response => {
          if (response.data.error){
      ...
      llenarFormulario() {
        ...
        this.infoEstudiante.documento = this.$store.state.documentoEstudianteNuevo        
        this.infoEstudiante.id_tipo_documento = null
        this.infoEstudiante.id_municipio_documento = '15001'
        this.infoEstudiante.nombre1 = null
        this.infoEstudiante.nombre2 = null
        this.infoEstudiante.apellido1 = null
        this.infoEstudiante.apellido2 = null
        this.infoEstudiante.fecha_nacimiento = null
        this.infoEstudiante.id_nacionalidad = '170'
        this.infoEstudiante.id_municipio_nacimiento = '15001'
        this.infoEstudiante.id_genero = null
        this.infoEstudiante.id_rh = '9'
        this.infoEstudiante.id_estrato = 2
        this.infoEstudiante.id_sisben = '0'
        ...
        this.infoEstudiante.direccion = null
        this.infoEstudiante.id_municipio_direccion = '15001'
        this.infoEstudiante.id_zona = 1
        this.infoEstudiante.telefono1 = null
        this.infoEstudiante.telefono2 = null
        this.infoEstudiante.correo = '@'
        ...
        this.infoEstudiante.id_sisbenA = 0
        this.infoEstudiante.id_epsA = '000000'
        this.infoEstudiante.direccionA = null
        this.infoEstudiante.id_municipio_direccionA = '15001'
        this.infoEstudiante.id_zonaA = 1
        this.infoEstudiante.telefono1A = null
        this.infoEstudiante.telefono2A = null
        this.infoEstudiante.correoA = '@'
        this.infoEstudiante.id_parentesco = null
