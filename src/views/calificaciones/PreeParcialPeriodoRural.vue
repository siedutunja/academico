  ...
  export default {
    ...
    methods: {
      ...
      async cargarNotasPeriodoPreescolar() {
        ...
        await axios
        .get(CONFIG.ROOT_PATH + 'docente/notas/planillapree/rural', {params: {idCurso: this.configuracionPlanilla.idCurso, idPeriodo: this.configuracionPlanilla.idPeriodo, idPlanilla: this.configuracionPlanilla.idPlanilla}})
        .then(response => {
          if (response.data.error){
