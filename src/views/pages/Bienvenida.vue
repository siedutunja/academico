  ...
  export default {
    ...
    methods: {
      ...
      async trazaProceso(descProceso) {
        ...
        let periodos
        if (this.$store.state.idInstitucion == 'c50f3d80-fca0-11ec-8267-536b07c743c4' || this.$store.state.idInstitucion == '8a1bd1e0-fcb2-11ec-8267-536b07c743c4' || this.$store.state.idInstitucion == '54fd7440-fc81-11ec-a1d1-1dc2835404e5') { //Silvino || Simon Bolivar || Sandoval
