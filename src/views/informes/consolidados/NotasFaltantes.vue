  ...
  <div>
    <b-row class="mt-2">
      <b-col lg="12">
        <b-card>
          <template #header>
            <h5 class="mb-0"><b-icon icon="card-checklist" aria-hidden="true"></b-icon> CONSOLIDADO NOTAS FALTANTES</h5>
          </template>
          <b-card-text>
            <b-row>
              <b-col lg="2">
  ...
  export default {
    ...
    methods: {
      ...
      imprimir() {
        ...
        let tituloInforme = 'CONSOLIDADO NOTAS FALTANTES'
      ...
      exportarAExcel() {
        ...
        XLSX.writeFile(wb, 'NotasFaltantes.xlsx')
      },
      redondear(num) {
